export const CHAT_SDK_ADAPTER_README_URL = 'https://www.npmjs.com/package/@notify/chat-sdk-adapter';
...
export function buildCodeWiringInstructions(projectDir: string): string {
  return [
    ...
    '',
    '1. Install deps if needed: @notify/chat-sdk-adapter and chat (state adapter only if you do not already have @chat-adapter/state-*)',
