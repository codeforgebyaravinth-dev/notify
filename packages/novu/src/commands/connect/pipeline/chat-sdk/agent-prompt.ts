...
export const CHAT_SDK_AGENT_PROMPT = [
  ...
  '- Existing Novu wiring: search for @notify/chat-sdk-adapter / createNovuAdapter and any /api/webhooks route so you do not duplicate it.',
  '- Conventions: match the existing formatting, lint rules, naming, and import style.',
  '',
  '## Implement',
  '1. Install @notify/chat-sdk-adapter (add a chat state adapter only if the project does not already have one).',
  ...
  '',
  '## Authoritative docs',
  '- Adapter API: https://www.npmjs.com/package/@notify/chat-sdk-adapter',
