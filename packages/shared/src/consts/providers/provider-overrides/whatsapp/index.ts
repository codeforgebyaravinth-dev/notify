/**
 * Entry point for the `@notify/shared/provider-overrides/whatsapp` subpath.
 *
 ...
 * `await import('@notify/shared/provider-overrides/whatsapp')` instead. Anything that only needs the
