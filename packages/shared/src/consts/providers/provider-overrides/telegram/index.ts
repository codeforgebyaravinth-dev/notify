/**
 * Entry point for the `@notify/shared/provider-overrides/telegram` subpath.
 *
 ...
 * `await import('@notify/shared/provider-overrides/telegram')` instead. Anything that only needs the
