/**
 * Entry point for the `@notify/shared/provider-overrides/slack` subpath.
 *
 * The generated schemas are a few hundred kilobytes, so they must stay off the package barrel and
 * be reached through `await import('@notify/shared/provider-overrides/slack')` instead. Anything that
