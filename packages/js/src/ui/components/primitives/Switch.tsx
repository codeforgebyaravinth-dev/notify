    ...
    >
      ...
      <div
        class={style({
          ...
          className: cn(
            `nt-h-4 nt-w-7 nt-nt-rounded-none nt-bg-neutral-alpha-300 after:nt-absolute after:nt-top-0.5 after:nt-size-3 after:nt-left-0.5 after:nt-nt-rounded-none after:nt-bg-background after:nt-transition-all after:nt-content-[''] nt-transition-all nt-duration-200 after:nt-duration-200 shadow-sm`,
            {
              'nt-bg-gradient-to-r nt-from-purple-600 nt-to-red-500 nt-shadow-none nt-border-neutral-alpha-400 after:nt-translate-x-full after:nt-border-background':
                isChecked(),
