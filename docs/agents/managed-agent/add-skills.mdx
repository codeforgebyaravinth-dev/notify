...
1. Open the [Notify dashboard](https://dashboard.novu.co) and go to your managed agent's detail page.
...
4. Paste the public repository URL. You can point to:
   - The root of a repo (Notify looks for SKILL.md at the top level).
   - A specific branch or subfolder (e.g. `https://github.com/org/repo/tree/main/skills/triage`).
5. Click **Upload**.

Notify downloads the files, bundles them, and sends them to the AI platform. The platform assigns a stable skill ID.
