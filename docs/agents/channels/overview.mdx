---
title: "Overview"
description: "Feature support matrix for Notify Connect on Slack, Microsoft Teams, WhatsApp, Telegram, and email."
sidebarTitle: Overview
---

Notify normalizes inbound events and outbound replies, but each provider exposes a different subset of UI features. Use this matrix when implementing replies, typing, edits, and tool approval.
