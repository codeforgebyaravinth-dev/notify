...
description: "View, inspect, and manage agent conversations in the Notify dashboard, including lifecycle state, message history, metadata, and per-channel activity."
---

Notify provides full observability for agent conversations across both managed agents and custom code agents. You can view and manage conversations in the Notify dashboard. Go to the Activity Feed page and switch to the **Agent Conversations** tab.
