...
description: 'Notify security, compliance, and data residency: SOC 2, ISO 27001, HIPAA, GDPR, regional API endpoints, and account-to-region binding rules.'
---
...
Notify Cloud is SOC 2 Type II compliant. We have completed penetration tests, security training, evidence collection, and follow secure development lifecycle (SDL) practices. You can see live control updates on our [Trust Center](https://trust.novu.co/).

### ISO 27001

Notify Cloud is ISO 27001 compliant. We have completed both Stage 1 and Stage 2 audits and fully defined ISMS requirements. This includes:
...
Notify Cloud is HIPAA compliant and we offer Business Associate Agreements (BAA) for customers who require them. This enables healthcare organizations and their partners to use Notify while maintaining compliance with healthcare data protection requirements.

### GDPR

Yes, Notify is fully GDPR compliant. You can see the complete compliance report on our [Trust Center](https://trust.novu.co/). Notify provides separate data residency options in both the EU and the US to support your compliance needs.

Notify Cloud customers can download our Data Processing Agreement (DPA) and Standard Contractual Clauses (SCC) template at [novu.co/dpa](https://novu.co/dpa).

## Data Residency

### Available Regions

Notify Cloud is available in the following regions:
...
<Warning>
  API keys are bound to the region where the account was created. Pointing an SDK, Inbox component, or API client at a different region's endpoint with the same key results in `401 Unauthorized`. To move an existing account to another region, contact [sales@notify.co](mailto:sales@notify.co) - you cannot self-migrate by changing the base URL.
</Warning>
...
To maintain data residency integrity, we cannot copy or move data between data warehouses in different regions. If you need to switch regions, please contact us at sales@notify.co to discuss your options.

### Self-Hosted and Hybrid Options

- **Open Source**: You control where your data is stored
- **Notify Hybrid-Cloud**: We help you deploy within your selected network infrastructure
...
If you need to delete specific data or information, reach out to us at support@notify.co.
...
- Choose the **Notify Hybrid-Cloud** enterprise plan
- Download our [Data Processing Agreement (DPA)](https://novu.co/dpa) and Standard Contractual Clauses (SCC) template
- Contact us at sales@notify.co, support@notify.co, or via [Discord](https://discord.novu.co)
...
- Email us at security@notify.co
