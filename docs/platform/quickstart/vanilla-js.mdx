---
title: 'Vanilla JS In-App Notifications Quickstart - Notify Inbox'
description: "Integrate the Notify Inbox component into a Vanilla JS or plain HTML project and start showing real-time in-app notifications without a frontend framework."
sidebarTitle: 'Vanilla JS'
---


Add real-time in-app notifications to a Vanilla JS and HTML project using the Notify Inbox component.

<Prompt description="Add Notify Inbox to my JavaScript app" icon="sparkles" actions={["copy", "cursor"]}>
# Add Notify Inbox to JavaScript App
...
- Initialize Notify after DOM content is loaded
...
<html lang="en">
  <head>
    ...
    <title>Notify Inbox - Vanilla JS</title>

    <!-- Notify Styles (important for proper UI rendering) -->
    <link
      rel="stylesheet"
      href="https://unpkg.com/@notify/js@3.11.0/dist/index.css"
    />
    <style>
      /*
  ...
  <body>
    <h2>Notify Inbox - Vanilla JS Demo</h2>

    <!-- Mount point: Notify will inject Inbox UI here -->
    <div id="notify-inbox"></div>

    <!--
    Notify UI for vanilla HTML:
  ...
  -->
    <script type="module">
      ...
      document.addEventListener("DOMContentLoaded", () => {
        const mountEl = document.getElementById("notify-inbox");
        if (!mountEl) {
          console.error("Missing #notify-inbox mount element");
          return;
        }
  ...
  ### Run Your Application
    Open `index.html` in your browser. You should see the Notify Inbox component with a bell icon.
