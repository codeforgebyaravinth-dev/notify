---
title: 'Delay Step'
description: "Configure the delay step in Notify workflows to pause execution for a duration or until a timestamp before the next channel step runs."
---
...
<iframe
  ...
  title="Learn how to use Scheduled delay in Notify workflow"
  frameBorder="0"
