---
title: 'Throttle Step'
description: "Use the throttle step in Notify workflows to cap notification frequency per subscriber, per workflow, and prevent spam during high-traffic events."
---
