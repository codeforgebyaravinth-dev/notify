---
title: 'Notification Workflows in Notify'
sidebarTitle: 'Workflows'
description: 'Create, configure, and trigger multi-channel notification workflows in Notify. Orchestrate email, SMS, push, in-app, and chat delivery.'
---

Notify Workflows orchestrate how notifications move from application events to messages delivered across one or more channels. A workflow combines delivery logic, message content, and execution rules into a single notification pipeline.
...
<Note>
  If you’re new to workflows, see the [Workflow core concept](/platform/concepts/workflows) for an in-depth overview of what workflows are and how they fit into Notify’s notification system.
</Note>

Notify Workflows help you:
