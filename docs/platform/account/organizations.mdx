---
title: 'Organizations'
description: 'Learn how Notify organizations work: creating orgs, switching between them, verified domains, and how they relate to environments and billing.'
---

An **organization** is the top-level account in Notify. Workflows, subscribers, integrations, API keys, and team members all belong to an organization and are further scoped to [environments](/platform/how-notify-works#organization-and-environments) within it.

<Note>
  Organization management features such as team invitations, role-based access control, and verified domains are available on Notify Cloud. RBAC requires a Team or Enterprise plan. See [Roles and permissions](/platform/account/roles-and-permissions) for plan details.
</Note>

## How organizations fit in Notify
...
When you sign up for Notify Cloud, you are prompted to create your first organization. You can create additional organizations later from the organization switcher in the dashboard sidebar.
...
Enterprise customers on Notify Cloud can extend organization security with:
...
Contact [support@notify.co](mailto:support@notify.co) or your Slack Connect channel to enable these features.

## Related topics

<Columns cols={2}>
  <Card title="Authentication" icon="key" href="/platform/account/authentication">
    Sign-in methods, MFA, and session management for Notify Cloud accounts.
  </Card>
  <Card title="How Notify works" icon="sitemap" href="/platform/how-notify-works">
