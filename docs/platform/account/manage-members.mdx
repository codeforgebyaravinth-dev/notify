---
title: 'Team members'
description: "Invite teammates, manage their permissions, transfer ownership, and remove members from your Notify organization to control who can build and run workflows."
---

You can manage the members of your organization from the **Settings** page in your Notify dashboard. From there, you can assign responsibilities, manage permissions, and control access to workflows and other features.
...
You can simplify member onboarding by allowing users with your organization's email domain to join automatically or request to join your Notify organization.
...
Users with a verified email domain can request to join your Notify organization. Only owners can approve or decline these requests.
...
You can remove members who no longer need access to your Notify organization. This action immediately revokes their access to your organization dashboard and signs them out. Only owners can perform this action.
