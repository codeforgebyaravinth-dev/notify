...
description: "Apply conditional display logic to notifications in the Notify Inbox component to show or hide items based on subscriber, workflow, or payload data."
---
