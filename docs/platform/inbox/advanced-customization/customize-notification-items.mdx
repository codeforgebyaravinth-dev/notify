...
Notify exposes render props to customize parts of the default Inbox notification item - subject, body, avatar, default/custom actions, or the entire notification.
...
Notify provides render props to customize actions:
