...
description: "Configure routing and click handling for notifications in the Notify Inbox using routerPush, onNotificationClick, and per-action redirect URLs."
---
...
The Inbox component uses the `routerPush` prop to make your notifications navigable. When you define a `redirect.url` in your workflow definitions, Notify automatically passes this URL to the `routerPush` function you provide.
