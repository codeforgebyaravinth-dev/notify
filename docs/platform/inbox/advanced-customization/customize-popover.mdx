...
description: "Display the Notify Inbox content outside the default popover and integrate it into your own custom popover, drawer, or full page layout."
---
...
You can render the notification feed directly into any part of your application, such as a dashboard panel or a dedicated notifications page. This is useful for situations where you don't need a popover trigger at all. Notify provides two components for this.
...
Use the Notifications or InboxContent components inside your own popover to keep all of Notify’s notification functionality while integrating with any external UI library. Trigger the popover with the Bell component or your own custom trigger.
...
export default function NotifyInbox() {
  return (
      ...
      >
        <Drawer direction="left">
          ...
          <DrawerContent className="w-[300px]">
            <DrawerHeader>
              <DrawerTitle>Notify Inbox</DrawerTitle>
            </DrawerHeader>
            <InboxContent />
          </DrawerContent>
        </Drawer>
