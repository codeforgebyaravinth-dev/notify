---
title: 'Localization'
description: "Customize the Notify Inbox UI for different languages using the localization prop to translate labels, empty states, and accessibility strings."
---
...
<Note>
  Localization is also fully supported in @notify/react-native. 
</Note>
