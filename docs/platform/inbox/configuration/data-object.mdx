---
title: 'Data Object'
description: "Attach custom metadata to in-app notifications with the data object in Notify workflows and read it inside the Inbox component for custom rendering."
---
...
You define the data object inside an in-app step in your workflow on the Notify dashboard.
