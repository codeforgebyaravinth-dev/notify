---
title: '@notify/js'
description: "Complete API reference for the @notify/js browser SDK, covering the Notify client, notification streams, preferences, counts, and session management."
---


## Notify

The Notify client provides methods to interact with notifications, preferences, and real-time events.
...
```typescript
import { SeverityLevelEnum } from '@notify/js';
...
The Notify client provides real-time event handling through WebSocket connections.
