---
title: "Subscription"
description: "Use useSubscriptions, useCreateSubscription, and related React hooks to fetch, create, and manage Notify topic subscriptions from your frontend."
---


The `@notify/react` package provides a set of Subscription hooks for managing topic subscriptions without using the prebuilt Subscription components. 
