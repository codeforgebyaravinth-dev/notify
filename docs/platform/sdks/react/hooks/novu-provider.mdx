...
description: "Use the NotifyProvider component to set up the Notify context, subscriber authentication, and shared configuration in your React application."
---
...
| `applicationIdentifier` | `string` | Your application identifier from Notify |
...
| `children` | `ReactNode` | The child components that will have access to the Notify context |
