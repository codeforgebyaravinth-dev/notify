---
title: 'Java'
description: "Connect a Java application to Notify with the official server SDK to trigger workflows, manage subscribers, and send notifications from JVM code."
---

Notify's Java SDK provides simple, yet comprehensive notification management, and delivery capabilities through multiple channels that you can implement using code that integrates seamlessly with your Java application.
