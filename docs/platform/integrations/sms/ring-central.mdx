---
title: "RingCentral SMS Integration with Notify"
sidebarTitle: "RingCentral"
description: "Connect RingCentral to Notify to send SMS notifications through workflows. Store your RingCentral client ID, client secret, JWT token, and sender in the Notify dashboard."
---

You can use [RingCentral](https://developers.ringcentral.com/guide/messaging) to send SMS messages through Notify.
...
## Creating a RingCentral integration with Notify

1. Visit the [Integrations](https://dashboard.novu.co/integrations?utm_campaign=docs-sms-ringcentral) page on Notify.
...
You can now send SMS notifications with RingCentral through Notify.
