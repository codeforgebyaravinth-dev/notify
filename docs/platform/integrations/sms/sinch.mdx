---
title: "Sinch SMS Integration with Notify"
sidebarTitle: "Sinch"
description: "Connect Sinch to Notify to send SMS notifications through workflows. Store your Service Plan ID, API token, sender, and region in the Notify dashboard."
---

You can use the [Sinch SMS API](https://developers.sinch.com/docs/sms/getting-started) to send SMS messages to your customers through Notify.
...
## Creating a Sinch integration with Notify

<Steps>
<Step title="Connect Sinch to Notify">
1. Visit the [Integrations](https://dashboard.novu.co/integrations?utm_campaign=docs-sms-sinch) page on Notify.
...
You can now send SMS notifications with Sinch through Notify.
