---
title: "Telnyx SMS Integration with Notify"
sidebarTitle: 'Telnyx'
description: "Connect Telnyx to Notify to send SMS notifications through workflows. Store your Telnyx API key and messaging profile in the dashboard for global SMS delivery."
---

You can use the [Telnyx](https://telnyx.com/) provider to send transactional emails to your customers using the Notify Platform with a single API to create multi-channel experiences.
...
<Step title="Connect Telnyx to Notify">
...
Now you can send notifications using Telnyx in Notify.
