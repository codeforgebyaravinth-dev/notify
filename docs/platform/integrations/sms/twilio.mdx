---
title: "Twilio SMS Integration with Notify"
sidebarTitle: 'Twilio'
description: "Connect Twilio to Notify to send SMS notifications through workflows. Store your Twilio account SID, auth token, and sender phone number in the Notify dashboard."
---
...
## Creating a Twilio integration with Notify

<Steps>
<Step title="Connect Twilio to Notify">
1. Visit the [Integrations Store](https://dashboard.novu.co/integrations) on Notify
...
Twilio supports processing and storing SMS data in specific regions. Notify lets you choose the API region when connecting your Twilio integration.
...
In the Twilio Console, create API credentials for the **IE1** region. Use those credentials in your Notify Twilio integration instead of your US credentials.
</Step>
...
<Step title="Select EU in Notify">
When connecting or updating your Twilio integration in Notify, set **Data residency region** to **EU (Ireland)** and save your IE1 credentials.
</Step>
</Steps>
