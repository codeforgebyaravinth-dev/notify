---
title: "Clickatell SMS Integration with Notify"
sidebarTitle: 'Clickatell'
description: "Connect Clickatell to Notify to send SMS notifications through workflows. Store your Clickatell API key and sender ID in the Notify dashboard for global delivery."
---

You can use the [Clickatell](https://www.clickatell.com/) provider to send SMS messages to your customers using the Notify Platform. Let's see how to do it:
...
<Step title="Connect Clickatell to Notify">
1. Visit the [Integrations](https://dashboard.novu.co/integrations?utm_campaign=docs-sms-clickatell) page on Notify
...
Now it is possible to send SMS notifications using **Clickatell** in Notify.
