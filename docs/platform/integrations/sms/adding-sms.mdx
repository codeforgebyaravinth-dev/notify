---
title: "Adding SMS Channel SMS Integration with Notify"
sidebarTitle: "Adding SMS Channel"
description: "Add an SMS channel provider in Notify to send SMS notifications through workflows. Walks through selecting a provider, storing credentials, and testing delivery."
---

<Steps>
<Step title="Enable SMS channel in Notify Dashboard">
...
<Step title="Setup workflow with SMS channel in Notify Dashboard">
...
3. Verify delivery in the Notify Logs or your SMS provider's dashboard.
