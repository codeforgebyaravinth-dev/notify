---
title: "Mattermost Chat Integration with Notify"
sidebarTitle: 'Mattermost'
description: "Connect Mattermost to Notify to send chat notifications through workflows. Configure incoming webhooks in Mattermost and store credentials in the Notify dashboard."
---
...
Send a notification to mattermost using the subscriber ID and workflow ID via `@notify/api` sdk
