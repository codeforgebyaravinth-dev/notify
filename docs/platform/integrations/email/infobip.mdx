---
title: "Infobip Email Integration with Notify"
sidebarTitle: 'Infobip'
description: "Connect Infobip Email to Notify to send transactional emails through workflows. Store your Infobip API key and base URL, then map senders for reliable delivery."
---

You can use the [Infobip](https://www.infobip.com/developers/) provider to send transactional emails to your customers using the Notify Platform with a single API to create multi-channel experiences.

## Getting Started

To use the Infobip provider in the email channel, you will need to create an Infobip account and add your API key and Base URL to the Infobip integration on the Notify platform.
...
## Creating an Infobip integration with Notify

- Visit the [Integrations](https://dashboard.novu.co/integrations?utm_campaign=docs-infobip) page on Notify.
...
- You should now be able to send notifications using Infobip in Notify.
