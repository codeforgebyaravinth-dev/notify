---
title: "Mandrill Email Integration with Notify"
sidebarTitle: 'Mandrill'
description: "Connect Mandrill (Mailchimp Transactional) to Notify to send transactional emails through workflows. Store your Mandrill API key and verified sender."
---

You can use the [Mandrill by Mailchimp](https://mandrillapp.com/) provider to send transactional emails to your customers using the Notify Platform with a single API.

## Getting Started

To use the Mandrill provider in the email channel, you will need to create a Mandrill account and add your API key to the Mandrill integration on the Notify platform.
...
## Creating the Mandrill integration with Notify

- Visit the [Integrations](https://dashboard.novu.co/integrations?utm_campaign=docs-mandrill) page on Notify.
...
- You should now be able to send notifications using Mandrill in Notify.
