---
title: "Netcore Email Integration with Notify"
sidebarTitle: 'Netcore'
description: "Connect Netcore (Pepipost) to Notify to send transactional emails through workflows. Store your Netcore API key and verified sender in the Notify dashboard."
---

You can use the [Netcore](https://netcorecloud.com/) provider to send transactional emails to your customers using the Notify Platform with a single API to create multi-channel experiences.

## Getting Started

To use the Netcore provider in the email channel, you will need to create a Netcore account and add your API key to the Netcore integration on the Notify platform.
...
## Creating a Netcore integration with Notify

- Visit the [Integrations](https://dashboard.novu.co/integrations?utm_campaign=docs-netcore) page on Notify.
...
- You should now be able to send notifications using Netcore in Notify.
