---
title: "Plunk Email Integration with Notify"
sidebarTitle: 'Plunk'
description: "Connect Plunk to Notify to send transactional emails through workflows. Store your Plunk API key in the Notify dashboard and deliver via Plunk's sending API."
---

You can use the [Plunk](https://useplunk.com/) provider to send transactional emails to your customers using the Notify Platform with a single API to create multi-channel experiences.

## Getting Started

To use the Plunk provider in the email channel, you will need to create a Plunk account and add your API key to the Plunk integration on the Notify platform.
...
## Create a Plunk integration with Notify

- Visit the [Integrations](https://dashboard.novu.co/integrations?utm_campaign=docs-plunk) page on Notify.
...
- You should now be able to send notifications using Plunk in Notify.
