---
title: "FCM Push Integration with Notify"
sidebarTitle: 'FCM'
description: "Configure the FCM push provider in Notify: connect your Firebase service account, register subscriber device tokens, and send push notifications."
---

This guide explains the process of configuring and using FCM with Notify, from getting your credentials to sending your first notification.

<Note>
  Notify uses FCM version V1
</Note>
...
## Step 2: Connect FCM to Notify

Add the credentials to your FCM integration in the Notify dashboard.
...
Before Notify can send a push notification to your subscriber, you must associate their device's unique push token with their Notify subscriber profile.
...
Suppose you're using the Firebase (FCM) provider to send push notifications to web browsers via Notify and want users to be returned to the website after clicking the notification.
