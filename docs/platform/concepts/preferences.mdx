---
title: 'Preferences'
description: "Learn how subscriber preferences work in Notify, how workflow-level and channel-level preferences interact, and how to expose settings to end users."
---

Notify provides a way to store subscriber preferences. This allows subscribers, your users, to specify and manage their preferences and customize their notifications experience.
...
<Steps>
  <Step title="Go to the Workflows page">
    Open the [Workflows page](https://dashboard.novu.co/workflows) in the Notify dashboard.
  </Step>
...
Notify resolves preferences per channel. It layers each type of preference on top of the previous one, from the most general to the most specific, and **the most specific layer that defines a channel wins**:
