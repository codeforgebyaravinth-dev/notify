---
title: 'Changelog'
description: "See the most recent product changes to Notify, follow release notes across the platform and SDKs, and learn how to help shape the roadmap."
---
...
<Columns cols={2}>
  <Card
    ...
    Browse version tags, release notes, and changelogs for every Notify release.
  </Card>
  <Card
    title="Notify's Changelog"
    icon="map"
    href="https://go.novu.co/changelog?utm_source=docs">
    Learn about what's changed, new features, bug fixes, and see Notify's history across versions.
  </Card>
</Columns>
...
Community is at the heart of everything we do at Notify. To get more involved with the community, you can:
