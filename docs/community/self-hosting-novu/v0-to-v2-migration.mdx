...
description: "Migrate a self-hosted Notify instance from the v0 to the v2 Dashboard with steps for data migration, feature flag changes, and workflow updates."
---

## Migrating from Notify Self-Hosted v0 to v2

This guide will help you migrate your existing Notify self-hosted v0 instance to v2. Due to significant architectural changes between versions, some manual steps are required, particularly for workflow migration.

## Terminology
- Web UI: The old Notify UI, that you are currently using.
- Dashboard: The new Notify UI, that is powered by the v2 APIs and architecture.
...
### Topics
Brand new topics page, to view and manage your topics in Notify.
...
You can still login to your old Notify Users and their passwords with the new Dashboard, 
...
<AccordionGroup>
  ...
  <Accordion title="What is the difference between Notify Cloud, Enterprise and Self-hosted?">
