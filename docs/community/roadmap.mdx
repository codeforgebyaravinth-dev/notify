---
title: 'Roadmap'
description: "Explore Notify's public roadmap covering upcoming features, in-progress work, and how to propose ideas that shape the notification infrastructure."
---


<Columns cols={2}>
  <Card
    title="Notify's Roadmap"
    icon="map"
