...
Notify is open-source infrastructure for managing notifications and agent conversations across different channel and messaging platforms, without rebuilding channel logic from scratch.

<div className="hero-cards dark:hidden">
  <Columns cols={2}>
    <Card title="Notify Platform" img="/images/home-page/inbox-light.png" href="/platform">
    ...
    <Card title="Notify Connect" img="/images/home-page/connect-light.png" href="/agents">
...
<div className="hero-cards hidden dark:block">
  <Columns cols={2}>
    <Card title="Notify Platform" img="/images/home-page/inbox-dark.png" href="/platform">
      Build notification workflows across Inbox, email, SMS, push, and chat. Trigger events, personalize delivery, and reach users on the right channel.
    </Card>
    <Card title="Notify Connect" img="/images/home-page/connect-dark.png" href="/agents">
      Connect AI agents to messaging providers with Agent Communication Infrastructure. Handle messages, identity, conversation state, and replies across every channel.
    </Card>
  </Columns>
</div>
...
<Columns cols={2}>
  <Card title="React quickstart" icon="rocket" href="/platform/quickstart/react">
    Add the Notify Inbox to a React application and send your first notification.
  </Card>
...
<Columns cols={2}>
  ...
  <Card title="Managed Agent" icon="sparkles" href="/agents/managed-agent/overview">
    Connect an agent built in AI platform like Claude directly to your Notify agent.
  </Card>
...
<Columns cols={3}>
  <Card title="Trigger outbound notifications" icon="send">
    Connect an agent built with the AI SDK to Notify Connect.
  </Card>
...
<div className="dark:hidden">
  <Frame caption="Connect and Notify together power a continuous communication experience for AI agents and products.">
    ![Notify communication infrastructure](/images/home-page/How-Notify-fits-together-light.png)
  </Frame>
</div>
<div className="hidden dark:block">
  <Frame caption="Connect and Notify together power a continuous communication experience for AI agents and products.">
    ![Notify communication infrastructure](/images/home-page/How-Notify-fits-together-dark.png)
  </Frame>
</div>
...
<Columns cols={2}>
  ...
  <Card title="API reference" icon="braces" href="/api-reference">
    Explore Notify REST APIs for events, subscribers, workflows, integrations, messages, and more.
  </Card>
  <Card title="Framework" icon="blocks" href="/framework">
    Build notification workflows as code with the Notify Framework.
  </Card>
</Columns>
...
<Columns cols={3}>
  <Card title="GitHub" icon="github" href="https://github.com/novuhq/novu">
    Star Notify, inspect the source, and contribute to the project.
  </Card>
  <Card title="Discord" icon="messages-square" href="https://discord.gg/novu">
    Ask questions and build with the Notify community.
  </Card>
