...
sidebarTitle: Schema
description: "Reference the Notify environment schema used in API requests and responses. Review fields, data types, and object structure for this resource."
---
