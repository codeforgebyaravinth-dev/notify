...
description: "Understand payload size limits for Notify API requests and workflow triggers. Structure event payloads to avoid validation failures and rejected requests."
---
