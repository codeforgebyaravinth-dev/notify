...
sidebarTitle: Schema
description: "Reference the Notify notification event schema used in API requests and responses. Review fields, data types, and object structure for this resource."
---
