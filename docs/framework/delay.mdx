---
title: 'Delay Action'
description: "Pause Notify Framework workflow execution for a fixed duration or until a specific timestamp using the delay step in your notification pipelines."
---
