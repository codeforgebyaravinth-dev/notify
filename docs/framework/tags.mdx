---
title: 'Tags'
description: "Implement and manage notification tags programmatically in Notify Framework to categorize workflows and control subscriber preferences in the Inbox."
---
