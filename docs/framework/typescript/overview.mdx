---
title: 'Notify Framework TypeScript SDK Overview'
description: "Learn how to use Notify's TypeScript SDK to build type-safe notification workflows with advanced features like payload validation and step controls."
sidebarTitle: Overview
---

Although you can trigger Notify workflows from any programming language using our Rest API SDKs.
...
Notify Framework was built and optimized with extreme focus on Developer Experience.
Our `@notify/framework` SDK is written in Typescript, and we recommend using Typescript for your own projects as well.
...
<Note>
  The `@notify/framework` SDK is compatible with Node.js version 20.0.0 and above.
</Note>
