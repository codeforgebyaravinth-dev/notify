---
title: 'Client'
description: "Configure the Notify Framework Client for global settings like API URL, secret key, strict authentication, and payload logging in your bridge app."
---
...
- **Description**: Your Notify Secret Key, used to sign the HMAC header to guarantee the authenticity of our requests.
