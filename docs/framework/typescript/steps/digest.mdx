---
title: 'Digest'
description: "Use the digest step in Notify Framework to aggregate multiple workflow events into a single notification using time windows and grouping keys."
---
