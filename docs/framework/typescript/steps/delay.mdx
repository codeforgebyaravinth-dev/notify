---
title: 'Delay'
description: "Use the delay step in Notify Framework to pause workflow execution for a specified duration or until an absolute timestamp before resuming."
---
