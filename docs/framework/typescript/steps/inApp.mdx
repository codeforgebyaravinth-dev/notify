---
title: 'In-App'
description: "Use the in-app step in Notify Framework to send notifications to your web or mobile inbox with rich content, actions, redirects, and per-user data."
---
