---
title: 'Email'
description: "Use the email step in Notify Framework to send email notifications with dynamic subject lines, HTML bodies, attachments, and React Email templates."
---
