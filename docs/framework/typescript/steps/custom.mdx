---
title: 'Custom'
description: "Use the custom step in Notify Framework to execute arbitrary TypeScript code, fetch data, or call third-party APIs during workflow execution."
---
