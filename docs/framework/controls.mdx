---
title: 'Controls'
description: "Use Controls in Notify Framework workflows to expose configurable options to non-developers, validated by Zod or JSON Schema at runtime."
---
...
**Control Schema** - For Non-Technical Peers and Developers. Managed in the Notify Dashboard UI, defined by developers and used by non-technical peers.
...
**[Zod](https://zod.dev/)** - A TypeScript-first schema declaration and validation library. _(Notify supports Zod v3)_
...
If you only want local IDE IntelliSense, you are able to pass plain JS Classes, which will not provide any Schema Definition useable by Notify Platform.

All provided **Zod** and **Class-Transformer** Schemas are compiled into **JSON Schema** which is passed to Notify. This ensures a consistent validation approach and UX by managing Payload and Control Data directly from the Platform.
