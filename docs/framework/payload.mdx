---
title: 'Payload'
description: "Define and validate workflow payload schemas in Notify Framework with Zod or JSON Schema to ensure type safety on data passed to novu.trigger."
---
