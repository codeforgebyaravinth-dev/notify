---
title: 'Skip Function'
description: "Skip individual steps of a Notify Framework workflow at runtime based on a condition function evaluated against payload, subscriber, and controls."
---
