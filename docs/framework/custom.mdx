---
title: 'Custom Step'
description: "Use the custom step in Notify Framework to run arbitrary business logic, fetch data, or integrate services as part of a workflow execution."
---
...
This JSON Schema definition is used to validate the output of the custom step. If the output does not match the schema, the workflow will fail. Notify Framework will infer the Typescript interface from the JSON Schema definition.
