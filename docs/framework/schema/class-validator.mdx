...
description: "Integrate class-validator with Notify Framework to validate workflow payload and step control schemas using TypeScript class decorators."
---

Notify Framework allows you to use [Class Validator](https://www.npmjs.com/package/class-validator) to define the [Control](/framework/controls) and [Payload](/framework/payload) schemas for your workflows.
...
<Steps>
    <Step title="Install Class Validator Packages">
        ...
        Notify requires the `class-validator-jsonschema` package to generate JSON schemas from your DTOs. You may also need the `reflect-metadata` package.
    </Step>
