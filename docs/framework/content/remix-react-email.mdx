...
description: "Integrate React Email templates with Notify Framework in a Remix application to render rich, responsive transactional emails inside your workflows."
---

Integrating Notify Framework with [React email](https://react.email/) for your Remix application can be done in three steps. If you don't have an app, you can [clone our Remix example](https://github.com/novuhq/novu-framework-remix-example).
