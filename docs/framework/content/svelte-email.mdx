---
title: 'Svelte Email'
description: "Use Svelte Email components with the Notify Framework to build responsive, reusable transactional email templates in your Svelte or SvelteKit project."
---

Integrating Notify Framework with [Svelte email](https://react.email/) for your Svelte application can be done in three steps. If you don't have an app, you can [clone our Svelte example](https://github.com/novuhq/novu-svelte-email).
