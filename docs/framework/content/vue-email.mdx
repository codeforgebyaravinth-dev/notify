---
title: 'Vue Email'
description: "Design responsive email templates for Notify workflows with Vue Email components and render them from your Framework email step at trigger time."
---

You can integrate Notify Framework with [Vue Email](https://vuemail.net/) in a few simple steps. This guide will walk you through the process of creating a new email template using Vue Email and Nuxt.
