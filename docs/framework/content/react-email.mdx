---
title: 'React Email'
description: "Design beautiful, responsive email templates for Notify workflows with React Email components and render them from your Framework email step."
---
