...
// @notify/application-generic which transitively pulls in pino/mongoose/ioredis.
...
import { startOtel } from '@notify/application-generic/build/main/tracing/otel-init';
